...
OpenClaw 网关是 Node.js 进程，需要访问 Anthropic/DeepSeek 等境外 API，但 Node.js 原生不支持 SOCKS5 代理，OpenClaw 也没有代理配置项。方案：用 proxychains4 在系统层拦截所有 TCP 连接，透明转发到本机 SOCKS5 代理（V2rayn 等）。
...
[ProxyList]
socks5 127.0.0.1 10808               # V2rayn SOCKS5 端口
```
